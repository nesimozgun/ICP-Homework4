...
We see some music performance videos on social media that are unique, unrepeatable and of course beautiful. We may want to preserve the ownership of these works of art in their current state and without being dependent on institutions. NFTs are a way to solve this by using just the URL.
